...
interface PropsType {
    ...
    actionComponent?: ({ id, ceirId, editCeirid }: NotSentProps) => React.JSX.Element; // add this props for userTableAction
}

export const NotSentTable: React.FC<PropsType> = ({
    displayData,
    api,
    fetch,
                            ...
                            {data.data?.map((row, index) => {
                                ...
                                return (
                                    <tr key={row['id']}>
                                        ...
                                        {actionComponent && Permission !== 'Operator' ? actionComponent({ id: row['id'], ceirId: row['ceirid'], editCeirid: row['editCeirid'] }) : null}
                                    </tr>
                                );
                            })}
                        </tbody>
