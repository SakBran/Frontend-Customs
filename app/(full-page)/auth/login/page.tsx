                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        ...
                        <div>
                            ...
                            <InputText id="password1" type="password"  value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Email address" className="w-full md:w-30rem mb-5" style={{ padding: '1rem' }} />
